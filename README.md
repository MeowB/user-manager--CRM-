# User Management CRM
This CRM app showcases a full user workflow from lead management to deal closure. It emphasizes realistic features like role-based permissions, activity tracking, and a deal pipeline, demonstrating both design thinking and front-end/back-end integration.
